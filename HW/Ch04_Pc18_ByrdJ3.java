...
public class Ch04_Pc18_ByrdJ3                                                                                       // declares Ch04_Pc18_ByrdJ3 class
{
   public static void main(String[] args)                                                                           // declares main method
   {
      ...
      System.out.printf( YOU_WIN + count + ATTEMPTS );                                                              // output
   } // main
   ...
   public static int[] getValidGuess( Scanner keyboard, int[] guessArray )
   {
      ...
      int guess = -1;                                                                                               // declare int guess.  Initialize to -1.  
      ...
      boolean goAgain = true;                                                                                       // ** Not needed, but added for readability. **
                                                                                                                      
      // while loop
      while (guessArray[3] != guess )
      {
