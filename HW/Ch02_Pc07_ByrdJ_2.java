...
public class Ch02_Pc07_ByrdJ_2                                                                     // declares Ch02_Pc07_ByrdJ_2 class
{
   public static void main(String[] args)                                                          // declares main() method
{
      ...
      final String OUTPUT_BUS_NAME = "\t THE HAPPY MART\n",                                        // output for Business NAME
                   OUTPUT_BUS_ADD = "\t 123 Sunny Avn \n",                                         // output for Business Address
                   OUTPUT_BUS_CSZ = "\t Abingdon, Va 24266 \n",                                    // output for city state zip
                   OUTPUT_BUS_PH = "\t 555-555-5555 \n\n",                                         // output for Business Phone
                   PROMPT_PRICE = "Enter price: $",                                                // Prompt for price
                   OUTPUT_PRICE = "Price: $",                                                      // output for price
                   OUTPUT_STATE_TAX = "State Tax: $",                                              // output State Tax
                   OUTPUT_CNTY_TAX = "County Tax: $",                                              // output country Tax
                   OUTPUT_TOTAL_TAX = "Total Tax: $",                                              // output total tax
                   OUTPUT_TOTAL_SALE = "Total Sale Price: $",                                      // output total sale
      ...
      outputMsg =   OUTPUT_BUS_NAME                                                                // output business name
                  ...
                  + OUTPUT_PRICE + price + NEW_LINE                         // Output price.  String.format("%.2f", value) formats the text to precision 2. 
                  + OUTPUT_STATE_TAX + stateSalesTaxAmt + NEW_LINE          // Output state tax 
                  + OUTPUT_CNTY_TAX + cntySalesTaxAmt + NEW_LINE            // Output county tax
                  + OUTPUT_TOTAL_TAX + totalSalesTax + NEW_LINE             // Output the total tax. Rounding the sum of taxes may reflect real-life accuracy.
                  + OUTPUT_TOTAL_SALE + totalSale                           // Output the total sale price
