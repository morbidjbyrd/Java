/*Excellent Job
-2, the if statement on line 48 should be an else-if – more transparent.
-0, when you define an array index to have a special meaning, e.g., your [1] is your min, your[2] is your max, etc. it can make the code less transparent.  
To address this, you can declare a constant to have the index value and thereby give the constant a mnemonic name, e.g., MIN = 1, MAX = 2, then array[MIN] and array[MAX], instead of array[1] and array[2].  
*/
